...
do
    ...
    output=$(python3 run_model_quip.py --model-name "kharinaev/Llama-3.1-8B-Instruct-quip" --datapath "~/llm_quant_safety/data/parts/p1.csv" --bs 48 --gpu-id 1 | tee /dev/tty)
