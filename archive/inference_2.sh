...
do
    ...
    output=$(python3 run_model_quip.py --model-name "kharinaev/Llama-3.1-8B-Instruct-quip" --datapath "~/llm_quant_safety/data/parts/p2.csv" --bs 32 --gpu-id 2 | tee /dev/tty)
